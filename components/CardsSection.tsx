...
const CARDS = [
  {
    ...
    desc: "Départs quotidiens Maroc ↔ Europe. Flotte 100% géolocalisable, renouvelée tous les 3 ans.",
  ...
  },
  {
    ...
    desc: "Semi-remorques frigorifiques KRONE & SCHMITZ avec enregistreurs de température.",
  ...
  },
  {
    ...
    desc: "Liaisons quotidiennes Maroc ↔ Europe avec véhicules spécifiques aux normes du transport industriel.",
...
export default function CardsSection() {
  return (
    <div className="cards-component" style={{ "--3467eec0": "#f0f4f8" } as any}>
      <div className="cards-component__central-block">
        ...
        <div className="cards-component__column">
          ...
          >
            <div className="cards-component-item__content">
              <h3 className="cards-component-item__title">{CARDS[0].title}</h3>
              <p className="cards-component-item__description">{CARDS[0].desc}</p>
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 64 64" width="64" height="64" className="nuxt-icon nuxt-icon--fill cards-component-item__icon icon-circled-arrow" style={{flexShrink:0}} name="circled-arrow">
                <path fill="currentColor" d="M43.671 30.146 33.167 19.642l2.12-2.122 14.127 14.126L35.61 45.45l-2.122-2.122 10.182-10.182h-27.67v-3z" className="i2118209033__arrow"></path>
                <path fill="currentColor" d="M60 32c0 15.464-12.536 28-28 28S4 47.464 4 32 16.536 4 32 4s28 12.536 28 28M6.904 32C6.904 45.86 18.14 57.096 32 57.096S57.096 45.86 57.096 32 45.86 6.904 32 6.904 6.904 18.14 6.904 32" className="i2118209033__circle-start"></path>
                <path fill="currentColor" d="M51.799 12.201a28 28 0 1 0 0 39.598l-2.053-2.053a25.096 25.096 0 1 1 0-35.492z" className="i2118209033__circle-end"></path>
              </svg>
            </div>
          </Link>
        </div>
        ...
        <div className="cards-component__column">
          {CARDS.slice(1).map((card, idx) => (
            ...
            >
              <div className="cards-component-item__content">
                <h3 className="cards-component-item__title">{card.title}</h3>
                <p className="cards-component-item__description">{card.desc}</p>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 64 64" width="64" height="64" className="nuxt-icon nuxt-icon--fill cards-component-item__icon icon-circled-arrow" style={{flexShrink:0}} name="circled-arrow">
                  <path fill="currentColor" d="M43.671 30.146 33.167 19.642l2.12-2.122 14.127 14.126L35.61 45.45l-2.122-2.122 10.182-10.182h-27.67v-3z" className="i2118209033__arrow"></path>
                  <path fill="currentColor" d="M60 32c0 15.464-12.536 28-28 28S4 47.464 4 32 16.536 4 32 4s28 12.536 28 28M6.904 32C6.904 45.86 18.14 57.096 32 57.096S57.096 45.86 57.096 32 45.86 6.904 32 6.904 6.904 18.14 6.904 32" className="i2118209033__circle-start"></path>
                  <path fill="currentColor" d="M51.799 12.201a28 28 0 1 0 0 39.598l-2.053-2.053a25.096 25.096 0 1 1 0-35.492z" className="i2118209033__circle-end"></path>
